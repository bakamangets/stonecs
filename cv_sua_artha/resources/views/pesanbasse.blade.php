...
@section('title', 'Custom Order Bass Elektrik')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <form action="{{ route('pesanbasse.simpan') }}" class="form-horizontal"  method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                    <div class="form-group">
                    <div class="col-sm-10">
                    <input   type="text" name="AlatMusik" value="Bass Elektrik" class="form-control" readonly>
                    </div>
