<?php $__env->startSection('title', 'Tambah Data Bahan'); ?>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<form action="<?php echo e(route('tambahbahan.simpan')); ?>" class="form-horizontal"  method="post" enctype="multipart/form-data">
				<?php echo e(csrf_field()); ?>
					...
					<div class="col-sm-10">
					<input   type="text" name="NamaBahan"  class="form-control" autofocus required>
					</div>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cv_sua_artha\resources\views/tambahbahan.blade.php ENDPATH**/ ?>