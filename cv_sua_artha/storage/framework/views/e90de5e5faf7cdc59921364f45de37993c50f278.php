<?php $__env->startSection('title', 'Detail Model'); ?>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-6">
              ...
              <div class="col-12">
                <img src="<?php echo e(asset('gambar_model/' .$model->Gambar)); ?>" class="product-image" alt="Model Image">
              </div>             
            </div>
            <div class="col-12 col-sm-6">
              <h3 class="my-3"><?php echo e($model->NamaModel); ?></h3>
              <p><?php echo e($model->KodeJenis); ?></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cv_sua_artha\resources\views/showmodel.blade.php ENDPATH**/ ?>