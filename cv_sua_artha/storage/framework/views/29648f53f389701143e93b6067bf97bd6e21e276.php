        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="<?php echo e($password_email_url); ?>" method="post">
                    ...
                    <button type="submit" class="btn btn-success btn-block btn-flat">Kirim link Reset Password
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cv_sua_artha\vendor\jeroennoten\laravel-adminlte\src/../resources/views/passwords/email.blade.php ENDPATH**/ ?>