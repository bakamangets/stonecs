        ...
        <aside class="main-sidebar <?php echo e(config('adminlte.classes_sidebar', 'sidebar-dark-primary elevation-4')); ?>">
            ...
            <?php else: ?>
                <a href="<?php echo e($dashboard_url); ?>" class="brand-link <?php echo e(config('adminlte.classes_brand')); ?>">
                    <img src="http://localhost/cv_sua_artha/public/logo.png" alt="" class="brand-image img-circle elevation-3" style="opacity: .8;width:50px;margin-top:5px;margin-left:5px;">
                    <span class="brand-text font-weight-light <?php echo e(config('adminlte.classes_brand_text')); ?>">
                        <?php echo config('adminlte.logo', '<b>Admin</b>LTE'); ?>
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cv_sua_artha\vendor\jeroennoten\laravel-adminlte\src/../resources/views/page.blade.php ENDPATH**/ ?>