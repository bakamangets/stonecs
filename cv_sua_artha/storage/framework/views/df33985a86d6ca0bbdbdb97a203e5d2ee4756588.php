    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Sign in untuk memulai session<!--<?php echo e(__('adminlte::adminlte.login_message')); ?>--></p>
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="icheck-primary">
                                ...
                                <label for="remember">Ingat Saya<!--<?php echo e(__('adminlte::adminlte.remember_me')); ?>--></label>
                            </div>
                        </div>
                        <div class="col-4">
                ...
                <p class="mt-2 mb-1" style="float:left;" >
                    <a href="<?php echo e($password_reset_url); ?>">lupa password
                        <!--<?php echo e(__('adminlte::adminlte.i_forgot_my_password')); ?>-->

                    </a>
                </p>
                <?php if($register_url): ?>
                    <p class="mb-0" style="float:right;margin-top:10px;" >
                        <a href="<?php echo e($register_url); ?>">Register
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cv_sua_artha\vendor\jeroennoten\laravel-adminlte\src/../resources/views/login.blade.php ENDPATH**/ ?>